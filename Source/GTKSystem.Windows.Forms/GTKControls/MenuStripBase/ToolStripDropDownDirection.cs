...
namespace System.Windows.Forms
{
    ...
    //     is displayed relative to its _parent control.
    public enum ToolStripDropDownDirection
    {
        //
        // 摘要:
        //     Uses the mouse position to specify that the System.Windows.Forms.ToolStripDropDown
        //     is displayed above and to the left of its _parent control.
        AboveLeft = 0,
        //
        // 摘要:
        //     Uses the mouse position to specify that the System.Windows.Forms.ToolStripDropDown
        //     is displayed above and to the right of its _parent control.
        AboveRight = 1,
        //
        // 摘要:
        //     Uses the mouse position to specify that the System.Windows.Forms.ToolStripDropDown
        //     is displayed below and to the left of its _parent control.
        BelowLeft = 2,
        //
        // 摘要:
        //     Uses the mouse position to specify that the System.Windows.Forms.ToolStripDropDown
        //     is displayed below and to the right of its _parent control.
        BelowRight = 3,
        //
        // 摘要:
        //     Compensates for nested drop-down controls and specifies that the System.Windows.Forms.ToolStripDropDown
        //     is displayed to the left of its _parent control.
        Left = 4,
        //
        // 摘要:
        //     Compensates for nested drop-down controls and specifies that the System.Windows.Forms.ToolStripDropDown
        //     is displayed to the right of its _parent control.
        Right = 5,
        //
        // 摘要:
